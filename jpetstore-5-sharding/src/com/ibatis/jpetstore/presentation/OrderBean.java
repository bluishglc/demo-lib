...
import com.ibatis.jpetstore.service.OderService;
import com.ibatis.jpetstore.service.ServiceFactory;
...
public class OrderBean extends AbstractBean {
  ...
  public OrderBean(OderService orderService) {
    order = new Order();
  ...
  public String viewOrder() {
    ...
    if (accountBean.getAccount().getId()==order.getUserId()) {
      return SUCCESS;
    } else {
      order = null;
